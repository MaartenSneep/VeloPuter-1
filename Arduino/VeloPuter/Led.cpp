...
public:
    ...
    {
        if (ledIntensity == offIntensity)
            setLedLow();
        else if (ledIntensity == lowIntensity)
            setLedMedium();
        else if (ledIntensity == mediumIntensity)
            setLedHigh();
        else if (ledIntensity == highIntensity)
            setLedMax();
    }
    ...
    void downLed(void) // lower the intensity
    {
        if (ledIntensity == lowIntensity)
            ...
            setLedMedium();
        else if (ledIntensity == maxIntensity)
            setLedHigh();
    }
};
